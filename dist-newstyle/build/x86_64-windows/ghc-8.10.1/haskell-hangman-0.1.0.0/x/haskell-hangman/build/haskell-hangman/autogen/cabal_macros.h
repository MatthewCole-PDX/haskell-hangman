...
/* package haskell-hangman-0.1.0.0 */
#ifndef VERSION_haskell_hangman
#define VERSION_haskell_hangman "0.1.0.0"
#endif /* VERSION_haskell_hangman */
#ifndef MIN_VERSION_haskell_hangman
#define MIN_VERSION_haskell_hangman(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_hangman */
...
#define CURRENT_COMPONENT_ID "haskell-hangman-0.1.0.0-inplace-haskell-hangman"
